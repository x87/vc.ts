...
async function body() {
  ...
  Streaming.RequestModel(lh_race01);
  Streaming.RequestModel(lh_race02);
  Streaming.RequestModel(lh_race03);
  Streaming.RequestModel(lh_race04);
  Streaming.RequestModel(lh_race05);
  Streaming.RequestModel(lh_race06);
  ...
  while (!(Streaming.HasModelLoaded(lh_race01)) || !(Streaming.HasModelLoaded(lh_race02)) || !(Streaming.HasModelLoaded(lh_race03)) || !(Streaming.HasModelLoaded(lh_race04)) || !(Streaming.HasModelLoaded(lh_race05)) || !(Streaming.HasModelLoaded(lh_race06))) {
    await asyncWait(0);
  }
  ...
  World.ClearArea(-967.7050, -827.3005, 2.0, 2.0, false /* FALSE */);
  World.ClearArea(-970.2131, -828.7170, 1.0, 1.0, false /* FALSE */);
  $.player1.setCoordinates(-970.2131, -828.7170, 5.7702);
  $.player1.setHeading(90.0);
  Camera.SetBehindPlayer();


  Camera.SetFixedPosition(-971.9697, -825.7239, 8.5712, 0.0, 0.0, 0.0);
  Camera.PointAtPoint(-970.9708, -825.7308, 8.6162, 2 /* JUMP_CUT */);


  Text.PrintHelpForever("RACEHLP");


  if (ONMISSION == 0) {
    $.race_route_2 = ScriptObject.CreateNoOffset(lh_race02, -965.584, -827.217, 8.631);
    $.race_route_3 = ScriptObject.CreateNoOffset(lh_race03, -965.584, -827.217, 8.631);
    $.race_route_4 = ScriptObject.CreateNoOffset(lh_race04, -965.584, -827.217, 8.631);
    $.race_route_5 = ScriptObject.CreateNoOffset(lh_race05, -965.584, -827.217, 8.631);
    $.race_route_6 = ScriptObject.CreateNoOffset(lh_race06, -965.584, -827.217, 8.631);
  }


  $.race_route_1 = ScriptObject.CreateNoOffset(lh_race01, -965.584, -827.217, 8.631);
}



async function race_selection_loop() {
  // SCM GOTO → race_selection_loop lowered to endless loop
  while (true) {
    ...
    const _res435 = Pad.GetPositionOfAnalogueSticks(0 /* PAD1 */);
$.lstickx = _res435.leftStickX;
$.lsticky = _res435.leftStickY;
$.rstickx = _res435.rightStickX;
$.rsticky = _res435.rightStickY;
    ...
    if (Pad.IsButtonPressed(0 /* PAD1 */, 15 /* TRIANGLE */)) {
      if ($.triangle_pressed_flag == 1) {
        ...
        // SCM GOTO → mission_races_failed (not lowered; manual jump required)
        throw new Error("unresolved GOTO mission_races_failed"); // fallback: would break linear control flow
      }
    }
    else {
    ...
    if ($.race_choice == 1) {
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.8, 2.0);
      Text.DisplayWithNumber(30.0, 145.0, "RACES00", $.race_choice); //Race ~1~:
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.8, 2.0);
      Text.Display(30.0, 165.0, "RACES01"); //Terminal Velocity
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if (Game.AreMeasurementsInMeters()) {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES13", 1, 748); //Track Length: ~1~.~1~ km
      }
      else {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES23", 1, 1); //Track Length: ~1~.~1~ miles
      }
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.65, 1.7);
      Text.DisplayWithNumber(30.0, 220.0, "RACES07", 100); //Entrance Fee: $~1~
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if ($.race1_best_time == 99999999) {
        Text.Display(30.0, 310.0, "RACES15"); //Best Time: N/A
      }
      else {
        ...
        if ($.seconds > 9) {
          Text.DisplayWith2Numbers(30.0, 310.0, "RACES08", $.mins, $.seconds); //Best Time: ~1~:~1~
        }
        else {
          Text.DisplayWith2Numbers(30.0, 310.0, "RACES22", $.mins, $.seconds); //Best Time: ~1~:0~1~
        }
      }
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if ($.race1_best_position == 99999999) {
        Text.Display(30.0, 325.0, "RACES16"); //Best Result: N/A
      }
      if ($.race1_best_position == 0) {
        Text.Display(30.0, 325.0, "RACES09"); //Best Result: 1ST
      }
      if ($.race1_best_position == 1) {
        Text.Display(30.0, 325.0, "RACES10"); //Best Result: 2ND
      }
      if ($.race1_best_position == 2) {
        Text.Display(30.0, 325.0, "RACES11"); //Best Result: 3RD
      }
      if ($.race1_best_position == 3) {
        Text.Display(30.0, 325.0, "RACES12"); //Best Result: 4TH
      }
    }
    ...
    if ($.race_choice == 2) {
      ...
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.8, 2.0);
      Text.Display(30.0, 165.0, "RACES02"); //OCEAN DRIVE
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if (Game.AreMeasurementsInMeters()) {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES13", 2, 659); //Track Length: ~1~.~1~ km
      }
      else {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES23", 1, 652); //Track Length: ~1~.~1~ miles
      }
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.65, 1.7);
      Text.DisplayWithNumber(30.0, 220.0, "RACES07", 500); //Entrance Fee: $~1~
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
    ...
    if ($.race_choice == 3) {
      ...
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.8, 2.0);
      Text.Display(30.0, 165.0, "RACES03"); //BORDER RUN
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if (Game.AreMeasurementsInMeters()) {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES13", 3, 1); //Track Length: ~1~.~1~ km
      }
      else {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES23", 1, 926); //Track Length: ~1~.~1~ miles
      }
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.65, 1.7);
      Text.DisplayWithNumber(30.0, 220.0, "RACES07", 1000); //Entrance Fee: $~1~
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
    ...
    if ($.race_choice == 4) {
      ...
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.8, 2.0);
      Text.Display(30.0, 165.0, "RACES04"); //CAPITAL CRUISE
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if (Game.AreMeasurementsInMeters()) {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES13", 3, 924); //Track Length: ~1~.~1~ km
      }
      else {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES23", 2, 438); //Track Length: ~1~.~1~ miles
      }
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.65, 1.7);
      Text.DisplayWithNumber(30.0, 220.0, "RACES07", 2000); //Entrance Fee: $~1~
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
    ...
    if ($.race_choice == 5) {
      ...
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.8, 2.0);
      Text.Display(30.0, 165.0, "RACES05"); //TOUR!
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if (Game.AreMeasurementsInMeters()) {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES13", 4, 603); //Track Length: ~1~.~1~ km
      }
      else {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES23", 2, 86); //Track Length: ~1~.~1~ miles
      }
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.65, 1.7);
      Text.DisplayWithNumber(30.0, 220.0, "RACES07", 5000); //Entrance Fee: $~1~
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
    ...
    if ($.race_choice == 6) {
      ...
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.8, 2.0);
      Text.Display(30.0, 165.0, "RACES06"); //ENDURANCE
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      if (Game.AreMeasurementsInMeters()) {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES13", 9, 721); //Track Length: ~1~.~1~ km
      }
      else {
        Text.DisplayWith2Numbers(30.0, 190.0, "RACES23", 6, 1); //Track Length: ~1~.~1~ miles
      }
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.65, 1.7);
      Text.DisplayWithNumber(30.0, 220.0, "RACES07", 10000); //Entrance Fee: $~1~
      await setup_text_shite();  // SCM GOSUB setup_text_shite
      Text.SetScale(0.6, 1.6);
      ...
      if ($.cross_pressed_flag == 1) {
        ...
        if ($.race_choice == 1) {
          if ($.player1.isScoreGreater(99)) {
            ...
            Text.ClearHelp();
            Text.UseCommands(false /* FALSE */);
            // SCM GOTO → race1_route_checkpoints (not lowered; manual jump required)
            throw new Error("unresolved GOTO race1_route_checkpoints"); // fallback: would break linear control flow
          }
          else {
            Text.PrintNow("RACES19", 3000, 1); //You cannot afford to enter this race.
          }
        }
        if ($.race_choice == 2) {
          if ($.player1.isScoreGreater(499)) {
            ...
            Text.ClearHelp();
            Text.UseCommands(false /* FALSE */);
            // SCM GOTO → race2_route_checkpoints (not lowered; manual jump required)
            throw new Error("unresolved GOTO race2_route_checkpoints"); // fallback: would break linear control flow
          }
          else {
            Text.PrintNow("RACES19", 3000, 1); //You do noy have enough money to enter this race.
          }
        }
        if ($.race_choice == 3) {
          if ($.player1.isScoreGreater(999)) {
            ...
            Text.ClearHelp();
            Text.UseCommands(false /* FALSE */);
            // SCM GOTO → race3_route_checkpoints (not lowered; manual jump required)
            throw new Error("unresolved GOTO race3_route_checkpoints"); // fallback: would break linear control flow
          }
          else {
            Text.PrintNow("RACES19", 3000, 1); //You do noy have enough money to enter this race.
          }
        ...
        if ($.race_choice == 4) {
          if ($.player1.isScoreGreater(1999)) {
            ...
            Text.ClearHelp();
            Text.UseCommands(false /* FALSE */);
            // SCM GOTO → race4_route_checkpoints (not lowered; manual jump required)
            throw new Error("unresolved GOTO race4_route_checkpoints"); // fallback: would break linear control flow
          }
          else {
            Text.PrintNow("RACES19", 3000, 1); //You do noy have enough money to enter this race.
          }
        ...
        if ($.race_choice == 5) {
          if ($.player1.isScoreGreater(4999)) {
            ...
            Text.ClearHelp();
            Text.UseCommands(false /* FALSE */);
            // SCM GOTO → race5_route_checkpoints (not lowered; manual jump required)
            throw new Error("unresolved GOTO race5_route_checkpoints"); // fallback: would break linear control flow
          }
          else {
            Text.PrintNow("RACES19", 3000, 1); //You do noy have enough money to enter this race.
          }
        ...
        if ($.race_choice == 6) {
          if ($.player1.isScoreGreater(9999)) {
            $.player1.addScore(-10000);
            $.race_route_6.delete();
            Text.ClearHelp();
            Text.UseCommands(false /* FALSE */);
            // SCM GOTO → race6_route_checkpoints (not lowered; manual jump required)
            throw new Error("unresolved GOTO race6_route_checkpoints"); // fallback: would break linear control flow
          }
          else {
            Text.PrintNow("RACES19", 3000, 1); //You do noy have enough money to enter this race.
          }
...
async function setup_text_shite() {
...
async function race1_route_checkpoints() {
  //////////////////////////////////////////////////////////////////
  ...
  // SCM GOTO → start_the_race (not lowered; manual jump required)
  throw new Error("unresolved GOTO start_the_race"); // fallback: would break linear control flow
}


//////////////////////////////////////////////////////////////////

async function race2_route_checkpoints() {
  //////////////////////////////////////////////////////////////////
...
async function race3_route_checkpoints() {
  //////////////////////////////////////////////////////////////////
...
async function race4_route_checkpoints() {
  //////////////////////////////////////////////////////////////////
...
async function race5_route_checkpoints() {
  //////////////////////////////////////////////////////////////////
  ...
  $.car1_stuck_x = 198.2140;
  $.car1_stuck_y = -373.8071;
  $.car1_stuck_z = 9.5658;


  $.car2_stuck_x = 196.4444;
  $.car2_stuck_y = -380.2955;
  $.car2_stuck_z = 9.6676;


  $.car3_stuck_x = 193.9106;
...
async function race6_route_checkpoints() {
  //////////////////////////////////////////////////////////////////
...
async function start_the_race() {
  ...
  Streaming.RequestModel(WFYPR);
  Streaming.RequestModel(BMYPI);
  Streaming.RequestModel(CHEETAH);
  Streaming.RequestModel(INFERNUS);
  Streaming.RequestModel(BANSHEE);


  $.blip_chase = Blip.AddForCoord($.cp0_x, $.cp0_y, $.cp0_z);


  while (!(Streaming.HasModelLoaded(WMYCR)) || !(Streaming.HasModelLoaded(WFYPR)) || !(Streaming.HasModelLoaded(BMYPI)) || !(Streaming.HasModelLoaded(CHEETAH)) || !(Streaming.HasModelLoaded(INFERNUS)) || !(Streaming.HasModelLoaded(BANSHEE))) {
    await asyncWait(0);
  }


  Path.SwitchRoadsOff($.road1_x, $.road1_y, $.road1_z, $.road2_x, $.road2_y, $.road2_z);


  $.race_car1 = Car.Create(CHEETAH, $.car1_stuck_x, $.car1_stuck_y, $.car1_stuck_z);
  $.race_car1.lockDoors(2 /* CARLOCK_LOCKED */);
  $.race_car1.setProofs(false /* FALSE */, true /* TRUE */, false /* FALSE */, false /* FALSE */, false /* FALSE */);
  $.race_car1.setWatertight(true /* TRUE */);
  $.race_car1.setStrong(true /* TRUE */);
  $.race_car1.setUpsidedownNotDamaged(true /* TRUE */);
  $.race_car1.setStraightLineDistance(5);
  $.race_car1.setCanBurstTires(false /* FALSE */);
  $.race_car1.setHeading($.car_headings);


  $.race_car2 = Car.Create(INFERNUS, $.car2_stuck_x, $.car2_stuck_y, $.car2_stuck_z);
  $.race_car2.lockDoors(2 /* CARLOCK_LOCKED */);
  $.race_car2.setProofs(false /* FALSE */, true /* TRUE */, false /* FALSE */, false /* FALSE */, false /* FALSE */);
  $.race_car2.setWatertight(true /* TRUE */);
  $.race_car2.setStrong(true /* TRUE */);
  $.race_car2.setUpsidedownNotDamaged(true /* TRUE */);
  $.race_car2.setStraightLineDistance(5);
  $.race_car2.setCanBurstTires(false /* FALSE */);
  $.race_car2.setHeading($.car_headings);


  $.race_car3 = Car.Create(BANSHEE, $.car3_stuck_x, $.car3_stuck_y, $.car3_stuck_z);
  $.race_car3.lockDoors(2 /* CARLOCK_LOCKED */);
  $.race_car3.setProofs(false /* FALSE */, true /* TRUE */, false /* FALSE */, false /* FALSE */, false /* FALSE */);
  $.race_car3.setWatertight(true /* TRUE */);
  $.race_car3.setStrong(true /* TRUE */);
  $.race_car3.setUpsidedownNotDamaged(true /* TRUE */);
  $.race_car3.setStraightLineDistance(5);
  $.race_car3.setCanBurstTires(false /* FALSE */);
  $.race_car3.setHeading($.car_headings);


  $.driver_car1 = Char.CreateInsideCar($.race_car1, 4 /* PEDTYPE_CIVMALE */, BMYPI);
  $.driver_car1.setCantBeDraggedOut(true /* TRUE */);
  $.driver_car1.setCanBeShotInVehicle(false /* FALSE */);


  $.driver_car2 = Char.CreateInsideCar($.race_car2, 4 /* PEDTYPE_CIVMALE */, WFYPR);
  $.driver_car2.setCantBeDraggedOut(true /* TRUE */);
  $.driver_car2.setCanBeShotInVehicle(false /* FALSE */);


  $.driver_car3 = Char.CreateInsideCar($.race_car3, 4 /* PEDTYPE_CIVMALE */, WMYCR);
  $.driver_car3.setCantBeDraggedOut(true /* TRUE */);
  $.driver_car3.setCanBeShotInVehicle(false /* FALSE */);
  ...
  $.race_car1.setDrivingStyle(2);
  $.race_car1.setCruiseSpeed(50.0);


  $.race_car2.setDrivingStyle(2);
  $.race_car2.setCruiseSpeed(50.0);


  $.race_car3.setDrivingStyle(2);
  $.race_car3.setCruiseSpeed(50.0);


  $.race_car1.setOnlyDamagedByPlayer(true /* TRUE */);
  $.race_car2.setOnlyDamagedByPlayer(true /* TRUE */);
  $.race_car3.setOnlyDamagedByPlayer(true /* TRUE */);
  ...
  Text.PrintNow("RACES_1", 5000, 1); //"~g~Get a fast car and get to the starting grid."


  while (!($.player1.locateStoppedInCar3D($.cp0_x, $.cp0_y, $.cp0_z, 2.0, 2.0, 2.0, true))) {
    await asyncWait(0);
    if ($.player1.locateStoppedOnFoot3D($.cp0_x, $.cp0_y, $.cp0_z, 2.0, 2.0, 2.0, true)) {
      Text.PrintNow("RACES_2", 5000, 1);
    }
    if (Car.IsDead($.race_car1)) {
      // SCM GOTO → mission_races_failed (not lowered; manual jump required)
      throw new Error("unresolved GOTO mission_races_failed"); // fallback: would break linear control flow
    }
    if (Car.IsDead($.race_car2)) {
      // SCM GOTO → mission_races_failed (not lowered; manual jump required)
      throw new Error("unresolved GOTO mission_races_failed"); // fallback: would break linear control flow
    }
    if (Car.IsDead($.race_car3)) {
      // SCM GOTO → mission_races_failed (not lowered; manual jump required)
      throw new Error("unresolved GOTO mission_races_failed"); // fallback: would break linear control flow
    }
    $.car_health = $.race_car1.getHealth();
    if ($.car_health < 1000) {
      $.car_health = 9;
    ...
    $.car_health = $.race_car2.getHealth();
    if ($.car_health < 1000) {
      $.car_health = 9;
      // SCM GOTO → race_start (not lowered; manual jump required)
      throw new Error("unresolved GOTO race_start"); // fallback: would break linear control flow
    }
    $.car_health = $.race_car3.getHealth();
    if ($.car_health < 1000) {
      $.car_health = 9;
      // SCM GOTO → race_start (not lowered; manual jump required)
      throw new Error("unresolved GOTO race_start"); // fallback: would break linear control flow
...
async function race_start() {
  $.race_car1.setOnlyDamagedByPlayer(false /* FALSE */);
  $.race_car2.setOnlyDamagedByPlayer(false /* FALSE */);
  $.race_car3.setOnlyDamagedByPlayer(false /* FALSE */);


  if ($.car_health == 9) {
    Text.PrintBig("RACES_3", 1200, 4); // "3..2..1.. GO GO GO!"
  }
  else {
    $.player1.setControl(false /* OFF */);
  ...
  $.blip_car1 = Blip.AddForCar($.race_car1);
  $.blip_car1.changeDisplay(1 /* MARKER_ONLY */);
  $.blip_car2 = Blip.AddForCar($.race_car2);
  $.blip_car2.changeDisplay(1 /* MARKER_ONLY */);
  $.blip_car3 = Blip.AddForCar($.race_car3);
  $.blip_car3.changeDisplay(1 /* MARKER_ONLY */);


  await get_next_checkpoint();  // SCM GOSUB get_next_checkpoint
  $.player1_cp_x = $.gosub_cp_x;
  $.player1_cp_y = $.gosub_cp_y;
  $.player1_cp_z = $.gosub_cp_z;
  $.blip_2nd_x = $.gosub_cp_2nd_x;
  ...
  $.blip_chase = Blip.AddForCoord($.player1_cp_x, $.player1_cp_y, $.player1_cp_z);
  $.blip_chase.changeColor(4 /* YELLOW */);
  $.blip_chase.changeScale(3);
  $.second_blip = Blip.AddForCoord($.blip_2nd_x, $.blip_2nd_y, $.blip_2nd_z);
  $.second_blip.changeColor(4 /* YELLOW */);
  $.second_blip.changeScale(2);
  $.race_car1.gotoCoordinates($.car1_cp_x, $.car1_cp_y, $.car1_cp_z);
  $.race_car2.gotoCoordinates($.car2_cp_x, $.car2_cp_y, $.car2_cp_z);
  $.race_car3.gotoCoordinates($.car3_cp_x, $.car3_cp_y, $.car3_cp_z);


  $.race_timer = 0;
  Hud.DisplayTimerWithString($.$id.race_timer, 0 /* TIMER_UP */, "RACES");
  ...
  while ($.player_cpcounter < $.total_checkpoints) {
    ...
    $.position = 0;
    if ($.player1.locateInCar3D($.player1_cp_x, $.player1_cp_y, $.player1_cp_z, 6.0, 6.0, 6.0, false)) {
      ...
      if ($.player_cpcounter == $.total_checkpoints) {
        // SCM GOTO → mission_races_passed (not lowered; manual jump required)
        throw new Error("unresolved GOTO mission_races_passed"); // fallback: would break linear control flow
      }
      if ($.player_cpcounter < $.total_checkpoints_minus1) {
        ...
        $.blip_chase = Blip.AddForCoord($.player1_cp_x, $.player1_cp_y, $.player1_cp_z);
        $.blip_chase.changeColor(0 /* RED */);
        $.blip_chase.changeScale(3);
      }
    }
    if (!(Car.IsDead($.race_car1))) {
      $.race_car1.setHealth(1000);
      ...
      await race_car_stuck_checks();  // SCM GOSUB race_car_stuck_checks
      ...
      if ($.race_choice > 4) {
        ...
        if ($.car1_cpcounter < $.car3_cpcounter_minus4 || $.car1_cpcounter < $.car2_cpcounter_minus4) {
          if (!($.player1.locateAnyMeansCar2D($.race_car1, 200.0, 200.0, false))) {
            if (!($.race_car1.isOnScreen())) {
              if (!(World.IsPointObscuredByAMissionEntity($.car1_cp_x, $.car1_cp_y, $.car1_cp_z, 4.0, 4.0, 3.0))) {
                if (!(Camera.IsPointOnScreen($.car1_cp_x, $.car1_cp_y, $.car1_cp_z, 4.0))) {
                  $.race_car1.setCoordinates($.car1_cp_x, $.car1_cp_y, $.car1_cp_z);
                  $.race_car1.turnToFaceCoord($.player1_cp_x, $.player1_cp_y);
                }
              }
            }
          }
      ...
      if ($.race_car1.locate3D($.car1_cp_x, $.car1_cp_y, $.car1_cp_z, $.car1_locate_size, $.car1_locate_size, $.car1_locate_size, false)) {
        ++$.car1_cpcounter;
        $.gosub_cpcounter = $.car1_cpcounter;
        await get_next_checkpoint();  // SCM GOSUB get_next_checkpoint
        $.car1_cp_x = $.gosub_cp_x;
        ...
        if ($.car1_cpcounter == $.total_checkpoints) {
          Text.PrintNow("RACES_8", 5000, 1); //"~r~You failed to win the race!"
          if ($.race_choice == 1) {
        ...
        if ($.car1_locate_size == 7.0) {
          ...
          $.race_car1.gotoCoordinatesAccurate($.car1_cp_x, $.car1_cp_y, $.car1_cp_z);
        }
      ...
      if (!($.race_car1.isInWater())) {
        $.car1_cpcounter = 0;
      }
      if ($.race_car1.isInWater()) {
        if (!($.race_car1.isOnScreen())) {
          const _res436 = $.race_car1.getCoordinates();
$.car_x = _res436.x;
$.car_y = _res436.y;
$.car_z = _res436.z;
          const _res437 = Path.GetClosestCarNode($.car_x, $.car_y, $.car_z);
$.car_x = _res437.nodeX;
$.car_y = _res437.nodeY;
$.car_z = _res437.nodeZ;
          if (!(World.IsPointObscuredByAMissionEntity($.car_x, $.car_y, $.car_z, 4.0, 4.0, 4.0))) {
            if (!(Camera.IsPointOnScreen($.car_x, $.car_y, $.car_z, 3.0))) {
              $.race_car1.setCoordinates($.car_x, $.car_y, $.car_z);
              $.race_car1.turnToFaceCoord($.car1_cp_x, $.car1_cp_y);
            }
          }
        }
      }
    ...
    if (!(Car.IsDead($.race_car2))) {
      ...
      if ($.race_choice > 4) {
        ...
        $.car3_cpcounter_minus4 = $.car3_cpcounter - 4;
        if ($.car2_cpcounter < $.car1_cpcounter_minus4 || $.car2_cpcounter < $.car3_cpcounter_minus4) {
          if (!($.player1.locateAnyMeansCar2D($.race_car2, 200.0, 200.0, false))) {
            if (!($.race_car2.isOnScreen())) {
              if (!(World.IsPointObscuredByAMissionEntity($.car2_cp_x, $.car2_cp_y, $.car2_cp_z, 4.0, 4.0, 3.0))) {
                if (!(Camera.IsPointOnScreen($.car2_cp_x, $.car2_cp_y, $.car2_cp_z, 4.0))) {
                  $.race_car2.setCoordinates($.car2_cp_x, $.car2_cp_y, $.car2_cp_z);
                  $.race_car2.turnToFaceCoord($.player1_cp_x, $.player1_cp_y);
                }
              }
            }
          }
      ...
      if ($.race_car2.locate3D($.car2_cp_x, $.car2_cp_y, $.car2_cp_z, $.car2_locate_size, $.car2_locate_size, $.car2_locate_size, false)) {
        ++$.car2_cpcounter;
        $.gosub_cpcounter = $.car2_cpcounter;
        await get_next_checkpoint();  // SCM GOSUB get_next_checkpoint
        $.car2_cp_x = $.gosub_cp_x;
        ...
        if ($.car2_locate_size == 7.0) {
          ...
          $.race_car2.gotoCoordinatesAccurate($.car2_cp_x, $.car2_cp_y, $.car2_cp_z);
        }
      ...
      if (!($.race_car2.isInWater())) {
        $.car2_cpcounter = 0;
      }
      if ($.race_car2.isInWater()) {
        if (!($.race_car2.isOnScreen())) {
          const _res438 = $.race_car2.getCoordinates();
$.car_x = _res438.x;
$.car_y = _res438.y;
$.car_z = _res438.z;
          const _res439 = Path.GetClosestCarNode($.car_x, $.car_y, $.car_z);
$.car_x = _res439.nodeX;
$.car_y = _res439.nodeY;
$.car_z = _res439.nodeZ;
          if (!(World.IsPointObscuredByAMissionEntity($.car_x, $.car_y, $.car_z, 4.0, 4.0, 4.0))) {
            if (!(Camera.IsPointOnScreen($.car_x, $.car_y, $.car_z, 3.0))) {
              $.race_car2.setCoordinates($.car_x, $.car_y, $.car_z);
              $.race_car2.turnToFaceCoord($.car2_cp_x, $.car2_cp_y);
            }
          }
        }
      }
    ...
    if (!(Car.IsDead($.race_car3))) {
      ...
      if ($.race_choice > 4) {
        $.car1_cpcounter_minus4 = $.car1_cpcounter - 4;
        $.car2_cpcounter_minus4 = $.car2_cpcounter - 4;
        if ($.car3_cpcounter < $.car1_cpcounter_minus4 || $.car3_cpcounter < $.car2_cpcounter_minus4) {
          if (!($.player1.locateAnyMeansCar2D($.race_car3, 200.0, 200.0, false))) {
            if (!($.race_car3.isOnScreen())) {
              if (!(World.IsPointObscuredByAMissionEntity($.car3_cp_x, $.car3_cp_y, $.car3_cp_z, 4.0, 4.0, 3.0))) {
                if (!(Camera.IsPointOnScreen($.car3_cp_x, $.car3_cp_y, $.car3_cp_z, 4.0))) {
                  $.race_car3.setCoordinates($.car3_cp_x, $.car3_cp_y, $.car3_cp_z);
                  $.race_car3.turnToFaceCoord($.player1_cp_x, $.player1_cp_y);
                }
              }
            }
          }
      ...
      if ($.race_car3.locate3D($.car3_cp_x, $.car3_cp_y, $.car3_cp_z, $.car3_locate_size, $.car3_locate_size, $.car3_locate_size, false)) {
        ++$.car3_cpcounter;
        $.gosub_cpcounter = $.car3_cpcounter;
        await get_next_checkpoint();  // SCM GOSUB get_next_checkpoint
        $.car3_cp_x = $.gosub_cp_x;
        ...
        if ($.car3_locate_size == 7.0) {
          ...
          $.race_car3.gotoCoordinatesAccurate($.car3_cp_x, $.car3_cp_y, $.car3_cp_z);
        }
      }
    }
    else {
      if (!($.race_car3.isInWater())) {
        $.car3_cpcounter = 0;
      }
      if ($.race_car3.isInWater()) {
        if (!($.race_car3.isOnScreen())) {
          const _res440 = $.race_car3.getCoordinates();
$.car_x = _res440.x;
$.car_y = _res440.y;
$.car_z = _res440.z;
          const _res441 = Path.GetClosestCarNode($.car_x, $.car_y, $.car_z);
$.car_x = _res441.nodeX;
$.car_y = _res441.nodeY;
$.car_z = _res441.nodeZ;
          if (!(World.IsPointObscuredByAMissionEntity($.car_x, $.car_y, $.car_z, 4.0, 4.0, 4.0))) {
            if (!(Camera.IsPointOnScreen($.car_x, $.car_y, $.car_z, 3.0))) {
              $.race_car3.setCoordinates($.car_x, $.car_y, $.car_z);
              $.race_car3.turnToFaceCoord($.car3_cp_x, $.car3_cp_y);
            }
          }
        }
      }
    ...
    if ($.player_cpcounter == $.total_checkpoints_minus1) {
      Fx.DrawWeaponshopCorona($.player1_cp_x, $.player1_cp_y, $.player1_cp_z, 5.5, 6 /* CORONATYPE_CIRCLE */, 0 /* FLARETYPE_NONE */, 150, 0, 0);
    }
    else {
      Fx.DrawWeaponshopCorona($.player1_cp_x, $.player1_cp_y, $.player1_cp_z, 5.5, 6 /* CORONATYPE_CIRCLE */, 0 /* FLARETYPE_NONE */, 150, 150, 0);
    }
...
async function mission_races_passed() {


  $.race_timer = $.race_timer / 1000;
  if ($.race_choice == 1) {
    Stat.RegisterFastestTime(6, $.race_timer);
    if ($.done_race1_progress == 0) {
  ...
  if ($.race_choice == 2) {
    Stat.RegisterFastestTime(7, $.race_timer);
    if ($.done_race2_progress == 0) {
      Stat.PlayerMadeProgress(1);
      Stat.RegisterOddjobMissionPassed();
  ...
  if ($.race_choice == 3) {
    Stat.RegisterFastestTime(8, $.race_timer);
    if ($.done_race3_progress == 0) {
      Stat.PlayerMadeProgress(1);
      Stat.RegisterOddjobMissionPassed();
  ...
  if ($.race_choice == 4) {
    Stat.RegisterFastestTime(9, $.race_timer);
    if ($.done_race4_progress == 0) {
      Stat.PlayerMadeProgress(1);
      Stat.RegisterOddjobMissionPassed();
  ...
  if ($.race_choice == 5) {
    Stat.RegisterFastestTime(10, $.race_timer);
    if ($.done_race5_progress == 0) {
      Stat.PlayerMadeProgress(1);
      Stat.RegisterOddjobMissionPassed();
  ...
  if ($.race_choice == 6) {
    Stat.RegisterFastestTime(11, $.race_timer);
    if ($.done_race6_progress == 0) {
      Stat.PlayerMadeProgress(1);
      Stat.RegisterOddjobMissionPassed();
  ...
  if ($.race_choice == 1) {
    ...
    Text.PrintWithNumberBig("RACES18", 400, 5000, 1); //YOU HAVE WON: $~1~
  }
  if ($.race_choice == 2) {
    ...
    $.player1.addScore(2000);
    Text.PrintWithNumberBig("RACES18", 2000, 5000, 1); //YOU HAVE WON: $~1~
  }
  if ($.race_choice == 3) {
    ...
    Text.PrintWithNumberBig("RACES18", 4000, 5000, 1); //YOU HAVE WON: $~1~
  }
  if ($.race_choice == 4) {
    ...
    Text.PrintWithNumberBig("RACES18", 8000, 5000, 1); //YOU HAVE WON: $~1~
  }
  if ($.race_choice == 5) {
    ...
    $.player1.addScore(20000);
    Text.PrintWithNumberBig("RACES18", 20000, 5000, 1); //YOU HAVE WON: $~1~
  }
  if ($.race_choice == 6) {
    ...
    $.player1.addScore(40000);
    Text.PrintWithNumberBig("RACES18", 40000, 5000, 1); //YOU HAVE WON: $~1~
  }
...
async function cleanup() {
  ...
  Path.SwitchRoadsOn($.road1_x, $.road1_y, $.road1_z, $.road2_x, $.road2_y, $.road2_z);
  $.blip_car1.remove();
  $.blip_car2.remove();
  $.blip_car3.remove();
  $.blip_chase.remove();
  ...
  Streaming.MarkModelAsNoLongerNeeded(WFYPR);
  Streaming.MarkModelAsNoLongerNeeded(BMYPI);
  ...
  Streaming.MarkModelAsNoLongerNeeded(lh_race01);
  Streaming.MarkModelAsNoLongerNeeded(lh_race02);
  Streaming.MarkModelAsNoLongerNeeded(lh_race03);
  Streaming.MarkModelAsNoLongerNeeded(lh_race04);
  Streaming.MarkModelAsNoLongerNeeded(lh_race05);
  Streaming.MarkModelAsNoLongerNeeded(lh_race06);


  Hud.ClearTimer($.$id.race_timer);
...
async function get_next_checkpoint() {
  ///////////////////////////////////////////////
...
async function race_car_stuck_checks() {
  ///////////////////////////////////////////////


  $.car_health = $.gosub_race_car.getHealth();
  if ($.car_health < 500) {
    $.gosub_race_car.setHealth(1000);
  }


  if ($.player_cpcounter == $.gosub_cpcounter) {
    const _res442 = $.gosub_race_car.getCoordinates();
$.car_x = _res442.x;
$.car_y = _res442.y;
$.car_z = _res442.z;
    ...
    $.car_distance_from_cp = Math.Sqrt($.sum_difference_d_xy);
    const _res443 = $.player1.getCoordinates();
$.car_x = _res443.x;
$.car_y = _res443.y;
$.car_z = _res443.z;
    $.difference_x_float_d = $.car_x - $.player1_cp_x;
    ...
    $.difference_y_float_d = $.difference_y_float_d * $.difference_y_float_d;
    $.sum_difference_d_xy = $.difference_x_float_d + $.difference_y_float_d;
    $.player1_distance_from_cp = Math.Sqrt($.sum_difference_d_xy);
  ...
  if (!($.gosub_race_car.locate3D($.car_stuck_x, $.car_stuck_y, $.car_stuck_z, 3.0, 3.0, 2.0, false))) {
    const _res444 = $.gosub_race_car.getCoordinates();
$.car_stuck_x = _res444.x;
$.car_stuck_y = _res444.y;
$.car_stuck_z = _res444.z;
  ...
  if ($.gosub_race_car.locate3D($.car_stuck_x, $.car_stuck_y, $.car_stuck_z, 3.0, 3.0, 2.0, false)) {
    ...
    if ($.stuck_timer > 4000) {
      if (!($.gosub_race_car.isOnScreen())) {
        const _res445 = $.gosub_race_car.getCoordinates();
$.car_x = _res445.x;
$.car_y = _res445.y;
$.car_z = _res445.z;
        const _res446 = Path.GetClosestCarNode($.car_x, $.car_y, $.car_z);
$.car_x = _res446.nodeX;
$.car_y = _res446.nodeY;
$.car_z = _res446.nodeZ;
        if (!(World.IsPointObscuredByAMissionEntity($.car_x, $.car_y, $.car_z, 4.0, 4.0, 3.0))) {
          if (!(Camera.IsPointOnScreen($.car_x, $.car_y, $.car_z, 4.0))) {
            $.gosub_race_car.setCoordinates($.car_x, $.car_y, $.car_z);
            $.gosub_race_car.turnToFaceCoord($.car3_cp_x, $.car3_cp_y);
          }
        }
      }
    }
  ...
  if ($.gosub_cpcounter < $.temp_int) {
    if ($.gosub_race_car == $.race_car1) {
      if (!($.race_car1.isOnScreen())) {
        if (!(World.IsPointObscuredByAMissionEntity($.car1_cp_x, $.car1_cp_y, $.car1_cp_z, 4.0, 4.0, 3.0))) {
          if (!(Camera.IsPointOnScreen($.car1_cp_x, $.car1_cp_y, $.car1_cp_z, 4.0))) {
            $.gosub_race_car.setCoordinates($.car1_cp_x, $.car1_cp_y, $.car1_cp_z);
            $.gosub_race_car.turnToFaceCoord($.player1_cp_x, $.player1_cp_y);
          }
        }
      }
    }
    if ($.gosub_race_car == $.race_car2) {
      if (!($.race_car2.isOnScreen())) {
        if (!(World.IsPointObscuredByAMissionEntity($.car2_cp_x, $.car2_cp_y, $.car2_cp_z, 4.0, 4.0, 3.0))) {
          if (!(Camera.IsPointOnScreen($.car2_cp_x, $.car2_cp_y, $.car2_cp_z, 4.0))) {
            $.gosub_race_car.setCoordinates($.car2_cp_x, $.car2_cp_y, $.car2_cp_z);
            $.gosub_race_car.turnToFaceCoord($.player1_cp_x, $.player1_cp_y);
          }
        }
      }
    ...
    if ($.gosub_race_car == $.race_car3) {
      if (!($.race_car3.isOnScreen())) {
        if (!(World.IsPointObscuredByAMissionEntity($.car3_cp_x, $.car3_cp_y, $.car3_cp_z, 4.0, 4.0, 3.0))) {
          if (!(Camera.IsPointOnScreen($.car3_cp_x, $.car3_cp_y, $.car3_cp_z, 4.0))) {
            $.gosub_race_car.setCoordinates($.car3_cp_x, $.car3_cp_y, $.car3_cp_z);
            $.gosub_race_car.turnToFaceCoord($.player1_cp_x, $.player1_cp_y);
          }
        }
      }
  ...
  if ($.gosub_cpcounter > $.temp_int) {
    $.gosub_race_car.setCruiseSpeed(25.0);
  }
  else {
    $.gosub_race_car.setCruiseSpeed(50.0);
  }
...
export async function races() {
  ...
  await body();  // SCM GOSUB mission_races_start


  if (HAS_DEATHARREST_BEEN_EXECUTED()) {
    await onFailed();  // SCM GOSUB mission_races_failed
  }


  await cleanup();  // SCM GOSUB mission_races_cleanup
